...
public class CustomTitle implements Listener {
    public static void sendTitleOnly(Player player, Integer fadeIn, Integer stay, Integer fadeOut, String message) {
        sendTitle(player, fadeIn, stay, fadeOut, message, null);
    }

    public static void sendSubtitleOnly(Player player, Integer fadeIn, Integer stay, Integer fadeOut, String message) {
